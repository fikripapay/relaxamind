    ...
    <section id="tess" class="my-5">
      <div class="container">
        ...
        <div class="row mt-5 justify-content-between">
          ...
          >
            <img
              src="assets/img/terapi-mindfulness/1.png"
              alt="Panduan Mindfulness"
          ...
          >
            <img
              src="assets/img/terapi-mindfulness/2.png"
              alt="Metode Mindfulness"
              class="img-fluid shadow rounded"
            />
          </div>
          <div
          ...
          >
            <iframe
              class="w-100 rounded"
              height="315"
              src="https://www.youtube.com/embed/Sq4rIN4VGaM?si=I3IrEv7EcnnpdjlY"
