...
<head>
    ...
    <title>LOGIN - Sistem Kenaikan Pangkat</title>
        ...
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material text-center" id="login-form" action="<?= base_url(); ?>auth/login/proses_login">
                    <img src="<?= base_url(); ?>assets/images/logo-icon.png" alt="Home" /><br/><img src="<?= base_url(); ?>assets/images/logo-text.png" alt="Home" />
                    <br>
                    <br>
                    <div class="row">
                        <div class="col-md-12">
