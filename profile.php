...
<body>
  ...
  <!-- Start Main Section -->
  <main class="py-5">
    <div class="logo text-center" data-aos="fade-up" data-aos-duration="1000">
      <img src="assets/img/icon/navbar.png" alt="Logo" width="200" />
    </div>
    <div class="sejarah">
      <div class="container mt-5 text-center">
        ...
        <div class="row justify-content-center mt-3">
          <div class="sejarah col-11 col-md-8 col-lg-6 border-2 border-start border-info" data-aos="fade-up" data-aos-duration="1000">
            <p>SMK Tonjong didirikan oleh Yayasan Dharma Bhakti dengan tujuan untuk berkontribusi dalam
              meningkatkan kualitas sumber daya manusia di Indonesia.</p>
            <p>
              Dalam upaya mencapai misi ini, Yayasan Dharma Bhakti Tonjong menjalin kerjasama dengan
              Pemerintah Daerah Kabupaten Bogor dan berbagai perusahaan swasta di Bogor. Kolaborasi ini
              bertujuan untuk mempersiapkan siswa/siswi agar
              siap untuk dunia kerja maupun berwirausaha.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container mt-5 text-center">
        ...
        <div class="row justify-content-center gap-3 mt-3">
          <div class="visi col-11 col-md-8 col-lg-6 border-2 border-start border-info" data-aos="fade-up" data-aos-duration="1000">
            <h3>Visi</h3>
            <p>Menciptakan siswa/siswi yang terdidik dan mandiri berlandaskan iman dan taqwa.</p>
          </div>
    ...
    <div class="container">
      <div class="row py-5 justify-content-sm-between">
        ...
        <div class="col-md-4">
          <h3>Lokasi</h3>
          <div class="lokasi">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7928.424564449169!2d106.75924559127593!3d-6.494785423989194!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c2f654a8a85b%3A0x51cf6d4a78fe70fc!2sYayasan%20Dharma%20Bakti%20SMK%20TONJONG!5e0!3m2!1sid!2sid!4v1712673758098!5m2!1sid!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </div>
    </div>
